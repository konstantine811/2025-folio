    ...
    <MainWrapperOffset isFullHeight>
      ...
      <div className="w-full flex flex-col bg-background text-foreground overflow-hidden">
        ...
        <nav className="h-16 border-b border-foreground/10 flex items-center justify-between px-6 bg-black z-10">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 hover:bg-white/5 transition-all text-sm font-medium text-zinc-400 hover:text-white hover:border-white/20"
            >
        ...
        <main className="w-full flex-1 relative bg-black flex items-center justify-center overflow-hidden">
          ...
          >
            <p className="text-zinc-500 text-sm font-mono tracking-[0.2em] uppercase">
              Visual Proof • a² + b² = c²
            </p>
          </div>
