...
interface Props {
  ...
  camMaxDis?: number;
  camMinDis?: number;
  camUpLimit?: number; // in rad
  camLowLimit?: number; // in rad
  camInitDir?: { x: number; y: number }; // in rad
  camMoveSpeed?: number;
  camZoomSpeed?: number;
...
const useFollowCamera = ({
  ...
  useEffect(() => {
    const onObjectAdded = (e: Object3DEventMap["childadded"]) =>
      customTraverseAdd(e.child);
    const onObjectRemoved = (e: Object3DEventMap["childadded"]) =>
