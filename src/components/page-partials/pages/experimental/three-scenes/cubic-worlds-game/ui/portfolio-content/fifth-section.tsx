...
const FifthSection = () => {
  ...
  const infoSkillY = useTransform(p, [0.3, 0.45], infoScale);
  return (
    <motion.div
            ...
            <div className="lg:w-3/4 flex flex-col gap-10 ">
              ...
              <div className="text-foreground/70 text-md lg:text-xl font-pixel flex flex-col gap-4">
                <div className="flex flex-col gap-4">
                  <Trans
                    i18nKey="cubic_worlds_game.portfolio.skills_section.visual_data"
