    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        ...
        <Input
          ...
          name={id}
          className={cn(
            "w-full bg-card border border-foreground/10 text-foreground text-sm rounded-sm p-3 focus:border-foreground/30 focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 focus:ring-1 focus:ring-foreground/30 transition-all placeholder:text-muted-foreground/80",
            icon && "pl-10"
          )}
