      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-background/80 rounded-xl px-4 pt-20 pb-24 md:p-6 shadow-lg w-full max-w-lg border border-foreground/20 backdrop-blur-xs max-h-screen overflow-y-auto"
